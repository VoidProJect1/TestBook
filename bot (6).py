...
# AI PROVIDERS
# =============================================================================
# Gemini: current working models as of 2026
GEMINI_MODELS = [
    "gemini-2.5-flash-preview-05-20",   # best free, fast
...
# Grok: current model names from xAI
GROK_MODELS  = ["grok-3-fast", "grok-3", "grok-2-latest"]
...
def handle_question(chat_id: int, uid: int, text: str, force_web: bool = False):
    ...
    try:
        ...
        if voice_on:
            ...
            # Typewriter effect — progressive edits
